 ...
 */
class RestRegistrationController extends RestServiceController implements ClassResourceInterface
{
    /**
    ...
    public function registerAction(Request $request)
    {
        ...
        $this->notify('User n°'.$user->getId().', username: '.$user->getUsername().' created'); 
